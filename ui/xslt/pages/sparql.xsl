...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" version="2.0">
  ...
  ?s ?p ?o
		...
		<div class="container-fluid content">
			<div class="row">
				<div class="col-md-12">
					<div class="alert alert-box alert-warning"><span class="glyphicon glyphicon-exclamation-sign"/>
						<strong>Note:</strong> This project is not supported by the British Museum. Links to the collection.britishmuseum.org namespace are
						automatically forwarded to a DESCRIBE query in this framework.</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<h1>SPARQL Query</h1>
					<p>For examples, see Matthew Lincoln's <a href="https://programminghistorian.org/en/lessons/graph-databases-and-SPARQL">tutorial</a> for
						querying British Museum data. A basic tutorial on SPARQL is available from <a href="http://jena.apache.org/tutorials/sparql.html">Apache
							Jena</a>.</p>
					<form role="form" id="sparqlForm" action="{$display_path}query" method="GET" accept-charset="UTF-8">
						...
						<div class="col-md-6">
							<p class="text-info">This endpoint (<xsl:value-of select="concat(/config/url, 'query')"/>) supports content negotiation for the
								following content types with SELECT queries: <code>text/html</code>, <code>text/csv</code>, <code>text/plain</code>,
									<code>application/sparql-results+json</code>, and <code>application/sparql-results+xml</code></p>
